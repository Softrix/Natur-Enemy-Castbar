...
DB[12825]  = { duration = 40,   cooldown = 0,    class = "MAGE",      crowdcontrol = true, diminish = true }      -- Polymorph (Rank 3)
DB[12826]  = { duration = 50,   cooldown = 0,    class = "MAGE",      crowdcontrol = true, diminish = true }      -- Polymorph (Rank 4, 50s Wowhead/TBC)
